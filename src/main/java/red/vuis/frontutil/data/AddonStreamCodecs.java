...
public final class AddonStreamCodecs {
	public static StreamCodec<ByteBuf, BFCountry> BF_COUNTRY = enumOrdinal(BFCountry.class);
	public static StreamCodec<ByteBuf, MatchClass> MATCH_CLASS = enumOrdinal(MatchClass.class);
	public static StreamCodec<RegistryFriendlyByteBuf, Loadout> LOADOUT = StreamCodec.ofMember(
		AddonStreamCodecs::encodeLoadout, AddonStreamCodecs::decodeLoadout
	);
	...
	private static void encodeLoadout(Loadout loadout, RegistryFriendlyByteBuf buf) {
	...
	public static Loadout decodeLoadout(RegistryFriendlyByteBuf buf) {
